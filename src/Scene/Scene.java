...
public class Scene {
	...
	public Scene(String sceneName1, Color background1, List<Geometry> geometries1, Camera camera1,
			double distanceViewPlane1,AmbientLight a,List<Light> lights1) {
...
// ***************** Getters/Setters ********************** //
	...
	/*************************************************
		...
		* addGeometry
		* PARAMETERS
		* Geometry - geometry we want to add
		* RETURN VALUE
		* void
		* MEANING
		* adds a geometry to list of geometrys
		* SEE ALSO
	**************************************************/
	...
	/*************************************************
            ...
            * addLight
            * PARAMETERS
            * Light - light we want to add
            * RETURN VALUE
            * void
            * MEANING
            * adds a light to list of lights
            * SEE ALSO
        **************************************************/
